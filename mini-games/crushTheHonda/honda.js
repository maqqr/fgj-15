...
function Honda(sprite, game, speed, x, y, playerNumber){
	this.speed = speed;
	this.score = 0;
...
Honda.prototype.move = function(x, y){
...
function PlayerWithKeys(left, right, up, down, primary, special, sprite, game, speed){
	var player = new Honda(sprite, game, speed);
	player.left = left;
	player.right = right;
	player.up = up;
	player.down = down;
...
Honda.prototype.setActivity = function(activity){
	this.isActive = activity;
	this.sprite.body.velocity.x = 0;
	this.sprite.body.velocity.y = 0;
}

Honda.prototype.registerPlayerAs = function(playerNumber){
	if(playerNumber == 1){
...
Honda.prototype.update = function(game){
...
Honda.prototype.shootMiddle = function(game, balls){
